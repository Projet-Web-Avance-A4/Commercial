                ...
                <div className="flex grid-cols-2">
                  ...
                  <div className="grid row-span-2">
                    <h4 className="font-bold text-large">
                      Bienvenue, {user?.name ?? 'Chargement...'} !
                    </h4>
              ...
              <CardBody>
                {user && (
                  <div className="grid grid-flow-row-dense auto-cols-max grid-cols-2 gap-5 p-3">
                    {Object.keys(user)
                      .filter((key) => key !== 'role' && key !== 'id_user' && key !== 'password'  && key !== 'status' && key !== 'code_referral' && key !== 'id_sponsor' )
                      .map((field) => (
                        <div key={field} className={field === 'mail' ? 'col-span-2' : ''}>
                          {isEditing ? (
                            <Input
                              ...
                              value={
                                isEditing
                                  ? modifiedUser?.[field as keyof User] ?? ''
                            ...
                            <div>
                              <div className="font-bold">
                                {fieldLabels[field as keyof User]} :
                              </div>
                ...
                <div className="flex justify-center space-x-4 mt-6 mb-6">
                  ...
                  {isEditing && (
                    ...
                    >
                      <p className="font-semibold r-0">Annuler</p>
                    </Button>
                  )}
                </div>
              </CardBody>
              ...
              <CardBody className="flex-grow p-4">
                ...
                <div className="flex justify-center space-x-4 mt-6 mb-6">
                  ...
                  >
                    ...
                    <p className="font-semibold r-0">Modifier le mot de passe</p>
                  </Button>
                </div>
                {alertMessage && (
                  <div>
